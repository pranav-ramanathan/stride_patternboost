const NB_LOCAL_SEARCHES::Int64 = 12000 # number of local searches to do at once. 
...
const NUM_INITIAL_EMPTY_OBJECTS = 5_000_000 #on the first run, this many rollouts will be done from empty graphs/objects
const FINAL_DATABASE_SIZE = 50_000 # Size of learning set
const TARGET_DB_SIZE = 5_000_000 # Database size will never be twice bigger than that
